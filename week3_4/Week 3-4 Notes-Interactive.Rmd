...
```{r bin1, exercise = T}
binom.barplot(5, 0.25, colour = "blue", rounding = 4, cex = 0.7)
title("Bin(n=5, p=0.25)")
```
...
```{r bin2, exercise = T}
binom.barplot(20, 0.5, colour = "blue", rounding = 4, cex = 0.4)
title("Bin(n=20, p=0.5)")
```
...
```{r bins, exercise = T}
par(mfrow = c(2, 1))
binom.barplot(6, 0.2, colour = "blue", rounding = 3, cex = 0.7)
title("Bin(n=6, p=0.2)")
binom.barplot(15, 0.5, colour = "blue", rounding = 3, cex = 0.7)
title("Bin(n=15, p=0.5)")
par(mfrow = c(1, 1))
```
